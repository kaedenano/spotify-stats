        ...
        <>
            ...
            >
                ...
                <SimpleGrid
                    ...
                    spacing={3}
                    my='20'>
                    <Link href={data?.artist[3]?.external_urls?.spotify}>
                        <Image rounded='2xl' src={data?.artist[3]?.images[0]?.url} />
                    </Link>
                    <Link href={data?.artist[4]?.external_urls?.spotify}>
                        <Image rounded='2xl' src={data?.artist[4]?.images[0]?.url} />
                    </Link>
                    <Link href={data?.artist[5]?.external_urls?.spotify}>
                        <Image rounded='2xl' src={data?.artist[5]?.images[0]?.url} />
                    </Link>
                    <Link href={data?.artist[6]?.external_urls?.spotify}>
                        <Image rounded='2xl' src={data?.artist[6]?.images[0]?.url} />
                    </Link>
                    <Link href={data?.artist[7]?.external_urls?.spotify}>
                        <Image rounded='2xl' src={data?.artist[7]?.images[0]?.url} />
                    </Link>
                    <Link href={data?.artist[8]?.external_urls?.spotify}>
                ...
                <VStack
                    mt='2'
                    justify='center'>
                    <Link href={data?.track[0]?.external_urls?.spotify}>
                        <Image
                            rounded='2xl'
